...
---
<br>
Apache Flink is well-supported in the broader ecosystem and works seamlessly with
...
<ul>
  <li><a href="https://kafka.apache.org/" target="_blank">Apache Kafka</a> (sink/source)</li>
  <li><a href="https://elastic.co/" target="_blank">Elasticsearch</a> (sink)</li>
  <li><a href="https://elastic.co/" target="_blank">Elasticsearch 2x</a> (sink)</li>
  <li><a href="http://hadoop.apache.org" target="_blank">Hadoop FileSystem</a> (sink)</li>
  <li><a href="http://www.rabbitmq.com/" target="_blank">RabbitMQ</a> (sink/source)</li>
  <li><a href="http://aws.amazon.com/kinesis/streams/" target="_blank">Amazon Kinesis Streams</a> (sink/source)</li>
  <li><a href="https://dev.twitter.com/docs/streaming-apis" target="_blank">Twitter Streaming API</a> (source)</li>
  <li><a href="https://nifi.apache.org" target="_blank">Apache NiFi</a> (sink/source)</li>
  <li><a href="https://cassandra.apache.org/" target="_blank">Apache Cassandra</a> (sink)</li>
  <li><a href="http://redis.io/" target="_blank">Redis</a> (sink)</li>
</ul>
